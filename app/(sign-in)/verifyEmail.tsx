...
export default function EmailVerification() {
  ...
  const handleVerify = () => router.push('./verifyPassword');
  const handleEmailPress = () => {/* Add email client opening logic */};
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subtitle}>Enter the code sent to the Email you provided.</Text>
        
        {/* Email Display */}
        <TouchableOpacity onPress={handleEmailPress}>
          <Text style={styles.emailText}>[**********@mail.com](https://www.verifyemail.com)</Text>
        </TouchableOpacity>
